...
## DISCLAIMER ⚠️
This project is a POC(Proof of concept). It is an End-to-End project to present the idea that how we can use ML into precision diabetes if developped at large scale with enough data. So don't use it for making diabetes decisions. 
